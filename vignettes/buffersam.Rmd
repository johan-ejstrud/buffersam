...
## Pause algorithm
It's possible to pause the execution of the algorithm while it's running to allow time for inspecting the progress `pause=TRUE`. This only makes sense if used together with one of the other feedback parameters.
